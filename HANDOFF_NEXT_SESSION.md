...
Phase 8 is open. Gate EV-P8-PRETOOLUSE-459 is CLOSED (trace, explanation, transfer — see the end of the ledger). Closure audit done; one composite cold phase gate is owed (see PHASE 8 CLOSURE AUDIT at the end of the ledger). Close the phase only if it passes. Both parsers and tool-call IDs already exist; do not rebuild them.
